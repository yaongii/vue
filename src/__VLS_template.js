import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name, name, addTodo, input_content, input_category, todos } from "./App.vue";
...
const __VLS_17 = __VLS_16({ ...{}, type: ("text"), placeholder: ("name here"), value: ((__VLS_ctx.name)), }, ...__VLS_functionalComponentArgsRest(__VLS_16));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_15, typeof __VLS_17> & Record<string, unknown>) => void)({ ...{}, type: ("text"), placeholder: ("name here"), value: ((__VLS_ctx.name)), });
...
const __VLS_22 = __VLS_21({ ...{}, class: ("create_todo"), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_20, typeof __VLS_22> & Record<string, unknown>) => void)({ ...{}, class: ("create_todo"), });
const __VLS_23 = __VLS_pickFunctionalComponentCtx(__VLS_20, __VLS_22)!;
let __VLS_24!: __VLS_NormalizeEmits<typeof __VLS_23.emit>;
{
const __VLS_25 = __VLS_intrinsicElements["h2"];
...
const __VLS_32 = __VLS_31({ ...{ "on-:submit": {} as any, }, id: ("new-todo-form"), }, ...__VLS_functionalComponentArgsRest(__VLS_31));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_30, typeof __VLS_32> & Record<string, unknown>) => void)({ ...{ "on-:submit": {} as any, }, id: ("new-todo-form"), });
const __VLS_33 = __VLS_pickFunctionalComponentCtx(__VLS_30, __VLS_32)!;
let __VLS_34!: __VLS_NormalizeEmits<typeof __VLS_33.emit>;
let __VLS_35 = { ':submit': __VLS_pickEvent(__VLS_34[':submit'], ({} as __VLS_FunctionalComponentProps<typeof __VLS_31, typeof __VLS_32>)["on-:submit"]) };
...
const __VLS_43 = __VLS_42({ ...{}, type: ("text"), class: ("todo_input"), placeholder: ("할 일을 입력해 주세요."), value: ((__VLS_ctx.input_content)), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_41, typeof __VLS_43> & Record<string, unknown>) => void)({ ...{}, type: ("text"), class: ("todo_input"), placeholder: ("할 일을 입력해 주세요."), value: ((__VLS_ctx.input_content)), });
const __VLS_44 = __VLS_pickFunctionalComponentCtx(__VLS_41, __VLS_43)!;
let __VLS_45!: __VLS_NormalizeEmits<typeof __VLS_44.emit>;
}
(__VLS_ctx.input_content);
{
const __VLS_46 = __VLS_intrinsicElements["div"];
const __VLS_47 = __VLS_elementAsFunctionalComponent(__VLS_46);
const __VLS_48 = __VLS_47({ ...{}, class: ("options"), }, ...__VLS_functionalComponentArgsRest(__VLS_47));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_46, typeof __VLS_48> & Record<string, unknown>) => void)({ ...{}, class: ("options"), });
const __VLS_49 = __VLS_pickFunctionalComponentCtx(__VLS_46, __VLS_48)!;
let __VLS_50!: __VLS_NormalizeEmits<typeof __VLS_49.emit>;
{
const __VLS_51 = __VLS_intrinsicElements["label"];
const __VLS_52 = __VLS_elementAsFunctionalComponent(__VLS_51);
const __VLS_53 = __VLS_52({ ...{}, class: ("label"), }, ...__VLS_functionalComponentArgsRest(__VLS_52));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_51, typeof __VLS_53> & Record<string, unknown>) => void)({ ...{}, class: ("label"), });
...
const __VLS_58 = __VLS_57({ ...{}, type: ("radio"), name: ("category"), id: ("category1"), value: ("business"), }, ...__VLS_functionalComponentArgsRest(__VLS_57));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_56, typeof __VLS_58> & Record<string, unknown>) => void)({ ...{}, type: ("radio"), name: ("category"), id: ("category1"), value: ("business"), });
...
const __VLS_63 = __VLS_62({ ...{}, class: ("bubble business"), }, ...__VLS_functionalComponentArgsRest(__VLS_62));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_61, typeof __VLS_63> & Record<string, unknown>) => void)({ ...{}, class: ("bubble business"), });
...
const __VLS_73 = __VLS_72({ ...{}, class: ("label"), }, ...__VLS_functionalComponentArgsRest(__VLS_72));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_71, typeof __VLS_73> & Record<string, unknown>) => void)({ ...{}, class: ("label"), });
...
const __VLS_78 = __VLS_77({ ...{}, type: ("radio"), name: ("category"), id: ("category2"), value: ("personal"), }, ...__VLS_functionalComponentArgsRest(__VLS_77));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_76, typeof __VLS_78> & Record<string, unknown>) => void)({ ...{}, type: ("radio"), name: ("category"), id: ("category2"), value: ("personal"), });
const __VLS_79 = __VLS_pickFunctionalComponentCtx(__VLS_76, __VLS_78)!;
let __VLS_80!: __VLS_NormalizeEmits<typeof __VLS_79.emit>;
(__VLS_ctx.input_category);
}
{
const __VLS_81 = __VLS_intrinsicElements["span"];
const __VLS_82 = __VLS_elementAsFunctionalComponent(__VLS_81);
const __VLS_83 = __VLS_82({ ...{}, class: ("bubble personal"), }, ...__VLS_functionalComponentArgsRest(__VLS_82));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_81, typeof __VLS_83> & Record<string, unknown>) => void)({ ...{}, class: ("bubble personal"), });
...
{
const __VLS_91 = __VLS_intrinsicElements["input"];
const __VLS_92 = __VLS_elementAsFunctionalComponent(__VLS_91);
const __VLS_93 = __VLS_92({ ...{}, type: ("submit"), value: ("Add Todo"), }, ...__VLS_functionalComponentArgsRest(__VLS_92));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_91, typeof __VLS_93> & Record<string, unknown>) => void)({ ...{}, type: ("submit"), value: ("Add Todo"), });
...
{
const __VLS_96 = __VLS_intrinsicElements["section"];
const __VLS_97 = __VLS_elementAsFunctionalComponent(__VLS_96);
const __VLS_98 = __VLS_97({ ...{}, class: ("todo_list"), }, ...__VLS_functionalComponentArgsRest(__VLS_97));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_96, typeof __VLS_98> & Record<string, unknown>) => void)({ ...{}, class: ("todo_list"), });
...
const __VLS_113 = __VLS_112({ ...{}, class: ("todo_item"), }, ...__VLS_functionalComponentArgsRest(__VLS_112));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_111, typeof __VLS_113> & Record<string, unknown>) => void)({ ...{}, class: ("todo_item"), });
...
const __VLS_118 = __VLS_117({ ...{}, for: (""), }, ...__VLS_functionalComponentArgsRest(__VLS_117));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_116, typeof __VLS_118> & Record<string, unknown>) => void)({ ...{}, for: (""), });
...
const __VLS_128 = __VLS_127({ ...{}, class: ("bubble personal"), }, ...__VLS_functionalComponentArgsRest(__VLS_127));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_126, typeof __VLS_128> & Record<string, unknown>) => void)({ ...{}, class: ("bubble personal"), });
...
const __VLS_133 = __VLS_132({ ...{}, class: ("todo_content"), }, ...__VLS_functionalComponentArgsRest(__VLS_132));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_131, typeof __VLS_133> & Record<string, unknown>) => void)({ ...{}, class: ("todo_content"), });
...
// @ts-ignore
[name, name, name, addTodo, input_content, input_content, input_content, input_category, input_category, input_category, todos, todos,];
}
...
__VLS_styleScopedClasses["create_todo"];
__VLS_styleScopedClasses["todo_input"];
__VLS_styleScopedClasses["options"];
__VLS_styleScopedClasses["label"];
__VLS_styleScopedClasses["bubble"];
__VLS_styleScopedClasses["business"];
__VLS_styleScopedClasses["label"];
__VLS_styleScopedClasses["bubble"];
__VLS_styleScopedClasses["personal"];
__VLS_styleScopedClasses["todo_list"];
__VLS_styleScopedClasses["list"];
__VLS_styleScopedClasses["todo_item"];
__VLS_styleScopedClasses["bubble"];
__VLS_styleScopedClasses["personal"];
__VLS_styleScopedClasses["todo_content"];
}
var __VLS_slots!: {};
return __VLS_slots;
}
